...
if (isset($_COOKIE['theme']) && $_COOKIE['theme'] === 'dark') {
    // Le thème sombre est activé, effectuez des opérations en conséquence
    $CONFIG = '{"lang":"fr","error_reporting":false,"show_hidden":false,"hide_Cols":true,"theme":"dark"}';
} else {
    // Le thème sombre n'est pas activé, effectuez d'autres opérations
    $CONFIG = '{"lang":"fr","error_reporting":false,"show_hidden":false,"hide_Cols":true,"theme":"light"}';
}
...
//Application Title
define('APP_TITLE', 'Easy-tk - Manager de fichiers');
...
$root_path = '/home/'.$_SERVER['PHP_AUTH_USER'].'/torrents/';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/rutorrent/files-manager/files/home/'.$_SERVER['PHP_AUTH_USER'].'/torrents/';
                ...
                <form id="js-settings-form" action="" method="post" data-type="ajax" onsubmit="return save_settings(this)">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
							...
							Réglage automatique avec le dark mode navigateur!
                        </div>
                    </div>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY): ?>
        <div class="col-xs-12 col-sm-9" style="margin-bottom: 100px;">
        ...
        <div class="col-3 d-none d-sm-block"></a></div>
        <?php else: ?>
...
<head>
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            ...
            body.theme-dark { background-color: #222; color: #CFD8DC; }
