...
shell_exec('sudo chmod -R 777 /home');  // remet les droit pour supprimer les fichier
...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => '../files/home/'.$_SERVER['PHP_AUTH_USER'].'/torrents/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../files/home/'.$_SERVER['PHP_AUTH_USER'].'/torrents/', // URL to files (REQUIRED)
		...
		array(
			'id'            => '1',
			'driver'        => 'Trash',
			//'path'          => '../files/home/'.$_SERVER['PHP_AUTH_USER'].'/torrents/.trash/',
			//'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '/../files/home/'.$_SERVER['PHP_AUTH_USER'].'/torrents/.trash/.tmb/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
